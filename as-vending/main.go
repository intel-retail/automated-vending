...
func main() {
	...
	lc.Infof("Running the application functions for %s and %s devices", vendingState.Configuration.CardReaderDeviceName, vendingState.Configuration.InferenceDeviceName)
	...
	err = service.SetFunctionsPipeline(
		transforms.NewFilterFor([]string{vendingState.Configuration.CardReaderDeviceName, vendingState.Configuration.InferenceDeviceName}).FilterByDeviceName,
