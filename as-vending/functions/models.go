...
type ServiceConfiguration struct {
	...
	DeviceControllerBoarddisplayReset string        // "http://localhost:48082/api/v2/device/name/ds-controller-board/command/displayReset"
	DeviceControllerBoarddisplayRow0  string        // "http://localhost:48082/api/v2/device/name/device-controller-board/command/displayRow0"
	DeviceControllerBoarddisplayRow1  string        // "http://localhost:48082/api/v2/device/name/device-controller-board/command/displayRow1"
	DeviceControllerBoarddisplayRow2  string        // "http://localhost:48082/api/v2/device/name/device-controller-board/command/displayRow2"
	DeviceControllerBoarddisplayRow3  string        // "http://localhost:48082/api/v2/device/name/device-controller-board/command/displayRow3"
	DeviceControllerBoardLock1        string        // "http://localhost:48082/api/v2/device/name/device-controller-board/command/lock1"
	DeviceControllerBoardLock2        string        // "http://localhost:48082/api/v2/device/name/device-controller-board/command/lock2"
	...
	InferenceDoorStatus               string        // "http://localhost:48082/api/v2/device/name/Inference-MQTT-device/command/inferenceDoorStatus"
	InferenceHeartbeat                string        // "http://localhost:48082/api/v2/device/name/Inference-MQTT-device/command/inferenceHeartbeat"
